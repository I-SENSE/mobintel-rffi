...
% file1_in = get_file_path(DIR_IN, 'epoch_2024-07-11_14-12-23', 'signal');
% file2_in = get_file_path(DIR_IN, 'epoch_2024-07-11_14-14-01', 'silent');
% file3_in = get_file_path(DIR_IN, 'node1-1_wifi_2021_03_01', 'old');
