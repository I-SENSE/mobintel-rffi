...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, SOURCE_FILEPATH, False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_gr_complex*52, TARGET_FILEPATH_CSI, False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, TARGET_FILEPATH_PCAP, True)
...
if __name__ == '__main__':
    antenna_name = sys.argv[1]

    print("Parsing data for " + antenna_name)

    SOURCE_FILEPATH = "/root/wireless/" + antenna_name + ".bin"
    TARGET_FILEPATH_PCAP = "/root/frames/" + antenna_name + ".pcap"
    TARGET_FILEPATH_CSI = "/root/frames/" + antenna_name + ".bin"
